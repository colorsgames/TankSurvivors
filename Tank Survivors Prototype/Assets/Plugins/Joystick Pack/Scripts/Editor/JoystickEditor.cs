...
public class JoystickEditor : Editor
{
    ...
    private SerializedProperty saveInputs;
    ...
    protected virtual void OnEnable()
    {
        ...
        saveInputs = serializedObject.FindProperty("saveInputs");
    ...
    protected virtual void DrawValues()
    {
        ...
        EditorGUILayout.PropertyField(saveInputs, new GUIContent("Save Inputs", "Save inputs after unclick??."));
    }
